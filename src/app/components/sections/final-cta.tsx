  ...
  return (
    <section className="relative w-full px-4 py-12 text-center sm:px-6 sm:py-16 lg:px-0 lg:py-20">
      ...
      <div className="relative z-10 mx-auto flex max-w-[1200px] flex-col items-center gap-6 sm:gap-8">
        ...
        <div className="flex w-full flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-8 lg:gap-12">
          <GradientButton variant="green" glow className="w-full max-w-[280px] sm:w-auto">
            Commencer Maintenant
          </GradientButton>

          <button
            type="button"
            className="relative inline-flex h-auto w-full max-w-[280px] items-center justify-center overflow-hidden rounded-[15px] px-5 py-[15px] font-grotesk text-base font-bold tracking-tight text-white shadow-[0_0_0_10px_rgba(255,255,255,0.15)] transition-opacity hover:opacity-90 sm:w-auto before:pointer-events-none before:absolute before:inset-0 before:rounded-[15px] before:p-0.5 before:content-[''] before:[background:linear-gradient(180deg,rgba(255,255,255,0.3)_0%,rgba(255,255,255,0.09)_100%)] before:[-webkit-mask-composite:xor] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[mask-composite:exclude]"
          >
            Parler à un expert
          </button>
        </div>
