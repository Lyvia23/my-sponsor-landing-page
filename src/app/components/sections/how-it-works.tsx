...
function StepCard({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[28px] border-[8px] border-white/[0.03]  ${className}`}
    >
      {/* Glow blob */}
      <div
      ...
      <div
        ...
        style={{
          background: `linear-gradient(${gradientDir}, transparent 24%, #1a0535 94%)`,
        }}
        aria-hidden="true"
      />
...
const STEPS = [
  {
    ...
    illustration: {
      ...
      className: "right-[10%] top-[10%] h-[65%] w-auto sm:h-[75%] opacity-90",
    },
    gradientDir: "155deg",
  },
  {
    ...
    illustration: {
      ...
      alt: "Types de collaborations",
      className: "right-[15%] top-[20%] h-[40%] w-auto sm:h-[45%] opacity-90",
    },
    gradientDir: "173deg",
  },
  {
    ...
    illustration: {
      ...
      alt: "Annonces",
      className: "right-[15%] top-[20%] h-[40%] w-auto sm:h-[45%]",
    },
    gradientDir: "176deg",
    glowColor: "#8a2dff4a",
  },
  {
    ...
    illustration: {
      ...
      alt: "Cible",
      className: "right-2 top-[20%] h-[40%] w-auto sm:right-[25%] sm:h-[45%]",
    },
    gradientDir: "149deg",
    glowColor: "#8a2dffad",
  },
  ...
  return (
    <section className="w-full px-4 py-10 sm:px-6 sm:py-12 lg:px-[100px] lg:py-16">
      <div className="mx-auto max-w-[1240px]">
        ...
        {/* Step grid */}
        <div className="grid gap-4 sm:grid-cols-1 sm:gap-5 xl:grid-cols-2">
          {STEPS.map((step) => (
            <StepCard key={step.number} {...(step as StepCardProps)} />
          ))}
        </div>
